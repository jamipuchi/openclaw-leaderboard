...
const endpoints: Endpoint[] = [
  ...
  "meta": { "page": 1, "pageSize": 20, "total": 142 }
    ...
    curlExample: `curl 'https://www.openclaw.rich/api/v1/leaderboard?page=1&pageSize=10&currency=USD'`,
  },
  {
    method: "GET",
  ...
  "data": {
    ...
    curlExample: `curl 'https://www.openclaw.rich/api/v1/submissions/clx1234abc'`,
  },
  {
    method: "POST",
  ...
  "data": {
    ...
    curlExample: `curl -X POST 'https://www.openclaw.rich/api/v1/submissions' \\
  ...
  "data": {
    ...
    curlExample: `curl -X POST 'https://www.openclaw.rich/api/v1/upload' \\
